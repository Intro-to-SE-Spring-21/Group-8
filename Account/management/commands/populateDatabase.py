...
class Command(BaseCommand):
    ...
    def handle(self,*args,**options):
        ...
        post_12 = Tweet.objects.create(tweet_creator=User.objects.get(pk=3), tweet_text="I love web development! #Confusion", pub_date="2021-01-25 15:33:25.16748")
        ...
        post_17 = Tweet.objects.create(tweet_creator=User.objects.get(pk=3), tweet_text="This project has no definition if we are even doing this right or wrong... Oh well. I'm about to run sound for Live Television, SEC Network: 1 Alabama @ Mississippi State University Basketball showtime @18:00", pub_date='2021-02-27 13:36:45.234532')